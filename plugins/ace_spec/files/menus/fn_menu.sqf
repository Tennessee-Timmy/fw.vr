...
private _title = ["ADMIN ACE SPECTATOR MENU",[0,0,14,1.2],true]call menus_fnc_addTitle;

private _button1 = ["Close spectator",[0.5,1.5,6,1],"[false] call ace_spectator_fnc_setSpectator;",-1]call menus_fnc_addButton;
_button1 ctrlSetTooltip "Close spectator interface, so you can use zeus instead";

private _button2 = ["Open Spectator",[0.5,3,6,1],"[true] call ace_spectator_fnc_setSpectator;",-1]call menus_fnc_addButton;
