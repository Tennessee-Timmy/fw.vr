...
["* Mission TFAR", "Add def. Radios",
{
	...
	private _button2 = ["Re-Add radios to EVERYONE",[0.5,2,10,1],"remoteExec ['tfr_fnc_addRadios',0];",-1,_newDisplay,_ctrlGroup] call menus_fnc_addButton;
...
["* Mission TFAR", "Reset Radio Settings",
{
	...
	private _button1 = ["Reset EVERYONE's Settings",[0.5,2,10,1],"remoteExec ['tfr_fnc_setupRadios',0]",-1,_newDisplay,_ctrlGroup]call menus_fnc_addButton;
