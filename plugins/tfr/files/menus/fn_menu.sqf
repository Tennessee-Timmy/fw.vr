...
private _title = ["TFAR MENU",[0,0,14,1.2],true]call menus_fnc_addTitle;

private _button1 = ["Reset EVERYONE's Settings",[0.5,1.5,10,1],"remoteExec ['tfr_fnc_setupRadios',0]",-1]call menus_fnc_addButton;
_button1 ctrlSetTooltip "Restore all radio settings for everyone";

private _button2 = ["Re-Add radios to EVERYONE",[0.5,3,10,1],"remoteExec ['tfr_fnc_addRadios',0];",-1]call menus_fnc_addButton;
...
_dropList = [
	...
	{remoteExec ["tfr_fnc_setupRadios",_this]}
...
_dropList2 = [
	...
	{remoteExec ["tfr_fnc_addRadios",_this]}
] call menus_fnc_dropList;
