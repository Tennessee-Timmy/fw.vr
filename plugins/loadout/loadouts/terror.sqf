...
#define MARKSMANRIFLEMAG	"ACE_20Rnd_65_Creedmor_mag"
#define MARKSMANRIFLEMAG2	"ACE_20Rnd_65_Creedmor_mag"
...
#define PISTOLMAG			"rhs_mag_9x19_17"
#define PISTOLMAG2			"rhs_mag_9x19_17"
#define PISTOL2				"rhs_weap_tt33"
#define PISTOL2MAG			"rhs_mag_762x25_8"
#define PISTOL2MAG2			"rhs_mag_762x25_8"
#define SMG					"SMG_01_F"
#define SMGMAG				"30Rnd_45ACP_Mag_SMG_01_Tracer_Red"
...
// Common Attachments
#define COMMONSCOPE			"optic_Arco_blk_F"
...
// Clothes
#define COMMON_UNI			"U_I_C_Soldier_Para_1_F"
#define COMMON_VEST			"V_PlateCarrier2_rgr_noflag_F"
#define COMMON_BAG			""
#define COMMON_HELMET		"H_Shemag_olive"
#define COMMON_GOGGLES		""

// Bags
#define BAGMEDIUM			"B_AssaultPack_rgr"
...
#define OFFICER_HELMET		"H_Beret_blk"
...
_commonCode = {
	if (isPlayer _target) then {
		...
		if ("acre" in mission_plugins) then {
			...
			_target setVariable ['unit_acre_preset','guer'];
			_target setVariable ['unit_acre_babel',["chinese"]];
...
_medicCode = {
	...
	_primaryAttachments pushBack 'optic_ACO_grn_smg';
};
