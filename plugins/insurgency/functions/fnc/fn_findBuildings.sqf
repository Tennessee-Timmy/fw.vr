...
_enterable = [];
{
	if (count (_x buildingPos -1) > 0) then {
		...
		if (typeof _x in ["Land_HouseV2_03","Land_Nasypka","Land_HouseV_1L2","Land_HouseV_1L1","Land_HouseV_1I1","Land_Misc_deerstand"] || _x distance getMarkerPos "respawn_west" < 700) exitWith {};
