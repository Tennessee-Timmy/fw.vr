...
_name = format["BRM_insurgency_camp_%1",_name];
...
[(_safePos),(100),(100),[east,2],[false,"SAFE","LIMITED"],false,[1,1],[true,false],0.8,[true,50,false,false]] call BRM_aiMaster_fnc_aiSpawnInf;
[(_safePos),(100),(300),[east,3],[false,"SAFE","LIMITED"],true,[2,2],[true,true],0.8,[true,50,false,false]] call BRM_aiMaster_fnc_aiSpawnInf;
[(_safePos),(50),(50),[east,3],[false,"SAFE","LIMITED"],false,[2,2],[false,true],0.8,[true,50,false,false]] call BRM_aiMaster_fnc_aiSpawnInf;
...
if (_task) then {
	...
	_cargo = [_cache, "blufor", _content] spawn BRM_fnc_assignCargo;
	_cache
};
