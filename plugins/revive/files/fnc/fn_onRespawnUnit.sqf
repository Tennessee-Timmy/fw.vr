...
_unit setVariable ['unit_revive_isRevived',false,true];
_unit setVariable ['unit_revive_canBeRevived',false,true];
private _oldUnit = _unit getVariable ['unit_revive_oldUnit',objNull];
_oldUnit setVariable ['unit_revive_canBeRevived',false,true];
_oldUnit setVariable ['unit_cleaner_disabled',false,true];
_unit setVariable ['unit_revive_oldUnit',objNull,true];
_unit setVariable ['unit_revive_canRespawn',false];
// currently disabled
/*
// Get/set unit side
